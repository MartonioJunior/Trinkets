...
namespace MartonioJunior.Trinkets.Currency {
  ...
  public class CurrencyEventListener
      : EngineBehaviour,
        IResourceProcessor<ICurrencyWallet, int> {
#region Constants
...
#region Variables
    ...
    */
    [SerializeField] Field<ICurrencyWallet> wallet =
        new Field<ICurrencyWallet>();
#else
    [field:SerializeField]
...
#region Delegate
    ...
    <param name="amount">The amount of the specified currency in the
    wallet.</param>
    */
...
#region EngineScrob Implementation
    ...
    <inheritdoc />
    */
    public override void Setup() { onAmountChange += OnAmountChange; }
    /**
    <inheritdoc />
    */
    public override void TearDown() { onAmountChange -= OnAmountChange; }
#endregion
