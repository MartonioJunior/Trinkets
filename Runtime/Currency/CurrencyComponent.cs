...
namespace MartonioJunior.Trinkets.Currency {
  ...
  */
  ...
  public class CurrencyComponent : EngineBehaviour,
                                   IResourceInstancer<ICurrencyWallet> {
#region Variables
    /**
...
#region EngineScrob Implementation
    ...
    <inheritdoc />
    */
    public override void Setup() { onCollectedCurrency += OnCollectedCurrency; }
    /**
    <inheritdoc />
    */
...
#region Methods
    ...
    */
    public void AddToWallet(CurrencyWallet wallet) { AddTo(wallet); }
    /**
    ...
    event.</remarks>
    */
    private void OnCollectedCurrency() { collectedCurrency?.Invoke(); }
#endregion
  }
}
