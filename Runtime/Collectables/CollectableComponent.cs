...
namespace MartonioJunior.Trinkets.Collectables {
  ...
  */
  ...
  public class CollectableComponent : EngineBehaviour,
                                      IResourceInstancer<ICollectableWallet> {
#region Variables
    /**
...
#region Events
    ...
    */
    [SerializeField]
    UnityEvent<bool> collectedEvent;
    /**
...
#region EngineBehaviour Implementation
    ...
    <inheritdoc />
    */
    public override void Setup() { onCollected += OnCollected; }
    /**
    <inheritdoc />
    */
    public override void TearDown() { onCollected -= OnCollected; }
#endregion
...
#region Methods
    ...
    */
    public void AddToWallet(CollectableWallet wallet) { AddTo(wallet); }
    /**
