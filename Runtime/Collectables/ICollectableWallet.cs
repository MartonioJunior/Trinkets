namespace MartonioJunior.Trinkets.Collectables {
  ...
  */
  public interface ICollectableWallet : IWallet,
                                        IResourceManager<ICollectable>,
                                        IResourceManager<ICollectableCategory> {
#region Methods
    /**
    <summary>Adds N collectables belonging to a category to the
    wallet.</summary> <param name="category">The category of which the
    collectables belong to.</param> <param name="amount">The amount of
    collectables to be added.</param>
    */
    void Add(ICollectableCategory category, int amount);
    /**
    <summary>Removes N collectables belonging to a category from the
    wallet.</summary> <param name="category">The category of which the
    collectables belong to.</param> <param name="amount">The amount of
    collectables to be removed.</param>
    */
  ...
  public static partial class ICollectableWalletExtensions {
    ...
    */
    public static bool Contains(this ICollectableWallet self,
