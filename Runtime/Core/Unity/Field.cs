...
public class Field<T>
{
    #region Variables
    /**
    <summary>Container for objects which inherit from <c>UnityEngine.Object</c>.</summary>
    */
    [SerializeField] Object unityObject;
    /**
    <summary>Container for C# structs and classes which do not inherit from <c>UnityEngine.Object</c>.</summary>
    */
