...
public static class Present
{
    ...
    public static HorizontalLayout Horizontal(params GUILayoutOption[] options)
    {
        return new HorizontalLayout(options);
    }

    public static HorizontalLayout Horizontal(GUIStyle style, params GUILayoutOption[] options)
    {
        return new HorizontalLayout(style, options);
    }

    public static void FlexibleLabel(string text, params GUILayoutOption[] options)
    {
    ...
    public static VerticalLayout Vertical(GUIStyle style, params GUILayoutOption[] options)
    {
